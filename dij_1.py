...
class Dijkstra(object):
    @classmethod
    def dijkstra(cls, graph: List[Node], start: Node, end: Node) -> Tuple[int, List[int]]:
        """
        ...
        while pq:
            ...
            for node_id, w in u.to_ids:
                ...
                if dist[u.idx] + w < dist[v.idx]:
                    ...
                    prev[v.idx] = (u, w)
                    heapq.heappush(pq, (dist[v.idx], v))
        return -1, []
...
if __name__ == '__main__':
    ...
    # se = [(1, 195)]
    for start, end in se:
        result = Dijkstra.dijkstra(obj.graph, obj.graph[start], obj.graph[end])
